  ...
  return (
    <Link
      ...
      className={`px-4 py-2 text-sm font-medium transition-colors ${
        active
          ? "text-white border-b-3 border-icici-orange-400 bg-icici-orange-500/20 px-4 py-2 font-bold"
          : "text-white/90 hover:text-white hover:bg-icici-orange-500/10 px-4 py-2 font-semibold transition-all duration-200"
      }`}
    >
      {label}
    </Link>
...
export function MainHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 icici-gradient-navy shadow-lg border-b-2 border-icici-orange-500">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-3">
            {/* ICICI-Style Logo Design */}
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-icici-orange-500 shadow-md border-2 border-white/20">
              <span className="text-2xl">🎓</span>
            </div>
            <div className="flex flex-col">
              <span className="text-xl font-bold text-white tracking-tight">Campus Store</span>
              <span className="text-[10px] text-icici-orange-300 font-semibold">COLLEGE <span className="font-bold">RENTALS</span></span>
            </div>
          </Link>
          {/* Desktop Navigation */}
